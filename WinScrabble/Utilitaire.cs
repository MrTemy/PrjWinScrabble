...
namespace WinScrabble
{
    ...
    public static class Utilitaire
    {
        ...
        /// <summary>
        /// Méthode que retourne le nombre de points que rapporte un mot
        /// </summary>
        /// <param name="mot">mot en type string</param>
        /// <returns>Nombre de points rapporté par le mot</returns>
